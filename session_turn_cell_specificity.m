function [spec_stats] = session_turn_cell_specificity(eptrials, clusts)
% 
...
% compute specificity statistics
for iclust = 1:length(clusts)
    spec_stats = (dHD_FRs_mean(1,:) - dHD_FRs_mean(num_ang_vel_bins,:))./(dHD_FRs_mean(1,:) + dHD_FRs_mean(num_ang_vel_bins,:));
end
