function [alltrials_rate, alltrials_spikes, alltrials_time] = trialbased_heatmap_LR(eptrials, clust, bins, min_trialvisits, min_dwelltime, trialtype_LR, varargin)
...
elseif trialtype_LR == 2
    included_vectors = intersect(correct_trials, right_trials);
end
