function [shuffle_outcomes] = shuffle_pdecodes(p_decodes, iterations)
...
for i = 1:iterations
    ...
    shuffle_outcomes(i, 1) = mean(cor_traj_like_trl(cor_traj_like_trl(:,8)<2 & cor_traj_like_trl(:,9)~=16 & cor_traj_like_trl(:,7)==1,3));
    shuffle_outcomes(i, 2) = mean(cor_traj_like_trl(cor_traj_like_trl(:,8)<2 & cor_traj_like_trl(:,9)~=16 & cor_traj_like_trl(:,7)==2,3));
