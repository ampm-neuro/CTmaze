    ...
    for session = 1:length_sessions %%FIX
        ...
        if exist(strcat(path_origin, rat, '/', session_file, '/clusts.csv'), 'file')
            ...
            if strcmp(stage, 'acclimation')
                ...
                %load
                [eptrials, clusters] = loadnl(strcat(rat, '/', session_file), str2num(rat));
            ...
            if strcmp(stage, 'acclimation')
                ...
                save(strcat(path_destination, 'neurodata/', rat, '/', stage, '/', session_number), 'eptrials', 'clusters', 'origin_file')
                ...
                %save session in correct destination folder
                save(strcat(path_destination, 'neurodata/', rat, '/', stage, '/', session_number), 'eptrials', 'clusters', 'stem_runs', 'origin_file')
