...
CSC = [CSC_time, zeros(length(CSC_time), 1), zeros(length(CSC_time), 1), NaN(length(CSC_time), 1), zeros(length(CSC_time), 1), NaN(length(CSC_time), 1), CSC_samp, zeros(length(CSC_time), 1)];
