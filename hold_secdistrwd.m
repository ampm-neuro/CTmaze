function hold_secdistrwd(eptrials, cells)
...
h2 = plot(1:6, crctsecdists(:, 2), '-', 'linewidth', 2, 'Color',[0.25 0.25 0.25]); %DarkGray
...
legend([h2 h2 h2], 'First Day', 'Mid Training', 'Criterion', 'location', 'northeastoutside');
...
%axis([0.75, 5.25, 0, 8])
%axis([0.75, 5.25, 0, 1.05*max(crctsecdists(:,2))])
