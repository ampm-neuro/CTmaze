...
%
min_trials = 13;
[stem_rates_21, rwd_rates_21, ID_idx_21] = ALL_keytimes_LR(2.1, min_trials);
[stem_rates_22, rwd_rates_22, ID_idx_22] = ALL_keytimes_LR(2.2, min_trials);
[stem_rates_23, rwd_rates_23, ID_idx_23] = ALL_keytimes_LR(2.3, min_trials);
[stem_rates_4, rwd_rates_4, ID_idx_4] = ALL_keytimes_LR(4, min_trials);
%}
...
%classify
[s_p_correct_21, s_assignments_21, s_distances_21] = md_classify(z_smr_21, ID_idx_21);
[s_p_correct_22, s_assignments_22, s_distances_22] = md_classify(z_smr_22, ID_idx_22);
[s_p_correct_23, s_assignments_23, s_distances_23] = md_classify(z_smr_23, ID_idx_23);
[s_p_correct_4, s_assignments_4, s_distances_4] = md_classify(z_smr_4, ID_idx_4);
[r_p_correct_21, r_assignments_21, r_distances_21] = md_classify(z_rmr_21, ID_idx_21);
[r_p_correct_22, r_assignments_22, r_distances_22] = md_classify(z_rmr_22, ID_idx_22);
[r_p_correct_23, r_assignments_23, r_distances_23] = md_classify(z_rmr_23, ID_idx_23);
[r_p_correct_4, r_assignments_4, r_distances_4] = md_classify(z_rmr_4, ID_idx_4);
